...
\code{files/lexer.txt}{Estrutura do Lexer}{lexer}
...
\code{files/table.txt}{Tabela de símbolos}{table}
...
\code{files/grammar.txt}{Gramática livre de contexto}{grammar}
...
\code{files/parser.txt}{Estrutura parcial do parser}{parser}
...
\code{files/compiler.txt}{Estrutura parcial do compilador}{compiler}
